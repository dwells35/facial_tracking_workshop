...
[0] Path to .xml file to use for Cascade.
    Default: %USERPROFILE%\\Envs\\facial_tracking\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml
...
path = os.path.expanduser('~\\Envs\\facial_tracking\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml')
